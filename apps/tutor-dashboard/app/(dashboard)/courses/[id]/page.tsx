...
//   async function handleAddVideos(data: ModuleSchemaType) {
//     const videoData = {
//       id: selectedModuleId,
//       title: data.title,
//       description: data.description,
...
//             </DialogHeader>
//             <form
//               onSubmit={form.handleSubmit(handleAddVideos)}
//               className="space-y-8"
//             >
//               <div className="space-y-4 py-4">
//                 <FormField
          ...
          <DialogContent>
            ...
            >
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={isAddingVideo || !videoFile}>
                  {isAddingVideo ? (
                    <>
          ...
          <DialogContent>
            ...
            >
              ...
              <DialogFooter>
                ...
                <Button
                  type="submit"
                  disabled={isAddingMaterial || !materialFile}
                >
                  {isAddingMaterial ? (
                    <>
                      <Loader className="mr-2 h-4 w-4 animate-spin" />
