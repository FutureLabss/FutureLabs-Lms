  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow mt-6 border w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lgg:grid-cols-3 xl:grid-cols-4 gap-5 mt-6">
        {prerecordedClasses && prerecordedClasses.length > 0 ? (
          prerecordedClasses.map((items) => (
            <div
              key={items.name}
              className="bg-white p-3 rounded-3xl shadow-2xl flex flex-col gap-2"
            >
              ...
              <div>
                <p className="text-sm font-semibold">{items.description}</p>
              </div>
          ...
          <p>No pre-recorded classes available.</p>
        )}
        {/* prerecordedClasses.map((items) => (
