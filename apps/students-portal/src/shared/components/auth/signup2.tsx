    ...
    <div className="md:px-[76px] xsm:px-4 2xl:px-[8rem] xsm:p-2">
      ...
      <div className=" 2xl:mt-[3rem]">
        ...
        >
          ...
          <span className="2xl:text-2xl md:text-[1.5rem] text-[1rem] font-semibold pl-2 text-[#212C4A]">
            Previous
          </span>
        </button>
        <div className="flex items-center space-x-4 ">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-gray-500 2xl:text-2xl md:text-[1.3rem] text-[1rem] font-semibold">
              Step 1
            </span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-black 2xl:text-2xl md:text-[1.3rem] text-[1rem] font-semibold">
              Step 2
            </span>
          </div>
        </div>
      ...
      >
        <div className="relative w-full">
          ...
          >
            <option selected className="text-[#686666]">
              Skill Choice
            </option>
        ...
        <div className="text-center">
          <p className="text-sm">
            ...
            <span className="text-[#007AFF] pl-2">
              {" "}
