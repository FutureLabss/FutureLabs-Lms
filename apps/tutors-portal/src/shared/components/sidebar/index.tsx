...
import SidebarMainNav from "@/shared/components/sidenarMainNav";
import SidebarClassroomNav from "@/shared/components/sidebarClassroomNav";
import SidebarUtilityNav from "@/shared/components/sidebarUtilityNav";
import SidebarUserProfile from "@/shared/components/sidebarUserProfile";
import SidebarAdminNav from "@/shared/components/sidebarAdminNav";
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  const isClassroomRoute =
    router.pathname.startsWith("/classroom/") ||
    router.pathname.startsWith("/classroom-feed/") ||
    router.pathname.startsWith("/classroom-management/");
